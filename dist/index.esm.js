...
function isoToCountryCode(isoCode) {
  ...
  throw new Error("The code ".concat(isoCode, " returns undefined, see https://www.flagpack.xyz/docs/flag-index for all the available codes."));
}
...
export { imageUrl, isoToCountryCode, registerFlag, registerFlagLibrary };
