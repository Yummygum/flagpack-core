...
var toCountryCode = function toCountryCode(name) {
...
function registerFlagLibrary(lib) {
  Object.entries(lib).forEach(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
        code = _ref2[0],
        data = _ref2[1];

    return registerFlag(code, data);
  });
}
...
exports.registerFlagLibrary = registerFlagLibrary;
